...
// #BULKHEAD_CHANGE(Veselin.Georgiev): [18/12/24] Make world partition builder change descriptions more consistent
	const FString ChangeDescription = FString::Printf(TEXT("Generated PCG components for %s"), *World->GetName());
// #BULKHEAD_CHANGE(Veselin.Georgiev): END
...
// #BULKHEAD_CHANGE(chris.eaves): [06/10/25] This function shouldn't be adding a grid size it has already found
		return;
// #BULKHEAD_CHANGE(chris.eaves): [06/10/25] End
	}
